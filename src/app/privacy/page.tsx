    ...
    <main className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <p>
            בהתאם לחוק הגנת הפרטיות, התשמ&quot;א-1981, הינך זכאי לעיין במידע שנאסף אודותיך ולבקש את תיקונו או מחיקתו. לבקשות בנושא, ניתן ליצור קשר בטלפון: 052-595-3928.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            לשאלות בנוגע למדיניות פרטיות זו, ניתן ליצור קשר בטלפון: 052-595-3928.
          </p>
        </section>
      </div>
